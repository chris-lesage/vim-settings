...
let s:gui0E = "63acad"
let s:gui0F = "77b081"
let s:gui10 = "5b4d3d" " comments
let s:gui11 = "252422" " commentsBG
let s:gui12 = "704040" " special characters
let s:gui13 = "505070" " non-active-status-bg
let s:gui14 = "706953" " special cursor yellow (search and split seperator)
let s:gui15 = "40403a" " matching parenthesis
...
call <SID>hi("MatchParen",    s:gui15, s:gui09, s:cterm0A, s:cterm01,  "reverse")
call <SID>hi("ModeMsg",       s:gui0B, "", s:cterm0B, "", "")
call <SID>hi("MoreMsg",       s:gui0B, "", s:cterm0B, "", "")
call <SID>hi("Question",      s:gui0A, "", s:cterm0A, "", "")
call <SID>hi("Search",        s:gui14, s:gui00, s:cterm0A, s:cterm01,  "reverse")
call <SID>hi("SpecialKey",    s:gui12, "", s:cterm03, "", "")
...
"call <SID>hi("Cursor",        s:gui04, "", s:cterm05, "", "reverse")
call <SID>hi("Cursor",        s:gui0A, s:gui02, s:cterm05, "", "reverse")
call <SID>hi("NonText",       s:gui12, "", s:cterm03, "", "")
call <SID>hi("Normal",        s:gui05, s:gui00, s:cterm05, s:cterm00, "")
call <SID>hi("LineNr",        s:gui03, s:gui01, s:cterm03, s:cterm01, "")
call <SID>hi("CursorLineNr",  s:gui09, s:gui01, s:cterm03, s:cterm01, "")
call <SID>hi("SignColumn",    s:gui05, s:gui00, s:cterm03, s:cterm01, "")
call <SID>hi("StatusLine",    s:gui08, s:gui03, s:cterm04, s:cterm02, "none")
call <SID>hi("StatusLineNC",  s:gui05, s:gui01, s:cterm03, s:cterm01, "italic")
call <SID>hi("VertSplit",     s:gui02, s:gui14, s:cterm02, s:cterm02, "none")
...
call <SID>hi("Comment",      s:gui10, "", s:cterm03, "", "italic")
...
call <SID>hi("String",       s:gui0C, "", s:cterm0B, "", "italic")
call <SID>hi("Structure",    s:gui0E, "", s:cterm0E, "", "")
call <SID>hi("Tag",          s:gui0A, "", s:cterm0A, "", "")
call <SID>hi("Title",        s:gui0D, s:gui00, s:cterm0D, s:cterm00, "none")
call <SID>hi("Todo",         "d8721e", s:gui00, s:cterm0A, s:cterm01, "reverse")
call <SID>hi("Debug",        s:gui14, s:gui00, s:cterm0A, s:cterm01, "reverse")
